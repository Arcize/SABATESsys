...
class FaultReportModel
{
    ...
    {
        try {
            $sql = "INSERT INTO reporte_fallas (id_usuario, id_equipo_informatico, contenido_reporte_fallas) 
                    VALUES (:id_usuario, :id_equipo_informatico, :contenido_reporte_fallas)";
    ...
    {
        try {
            $sql = "SELECT * FROM reporte_fallas WHERE id_reporte_fallas = :id";
            $stmt = $this->db->prepare($sql);
    ...
    public function readPage($page, $recordsPerPage)
    {
        ...
        try {
            $sql = "SELECT * FROM reporte_fallas ORDER BY id_reporte_fallas LIMIT :recordsPerPage OFFSET :offset";
            $stmt = $this->db->prepare($sql);
