    ...
    g.extend(n.prototype, {
          ...
          : ((s = this.s.d),
            ...
            (!e && void 0 !== e) ||
              (this.s.d
                ? this._writeOutput(
                    !1,
                    (null === s && null !== this.s.d) ||
                      (null !== s && null === this.s.d) ||
                      s.toString() !== this.s.d.toString()
                  )
            ...
            if (24 === a)
              ...
              var u =
                  ...
                  ('</tbody></thead><table class="' +
                    ...
                    l +
                    '-nospace"><tbody>'),
                T = null !== t ? t : -1 === o ? 0 : 10 * Math.floor(o / 10);
              for (u += "<tr>", p = T + 1; p < T + 10; p++) u += m(p, i(p));
              u += "</tr>";
            }
            c = 6;
          }
      ...
      _show: function () {
        ...
        s !== i.body &&
          ...
          clearTimeout(this.s.showTo),
          this.dom.input.on("blur", function (t) {
            e.s.showTo = setTimeout(function () {
              var t = i.activeElement.tagName.toLowerCase();
              i.activeElement === e.dom.input[0] ||
                e.dom.container.find(i.activeElement).length ||
                (["input", "select", "button"].includes(t) && e.hide());
            }, 10);
          }),
          setTimeout(function () {
      ...
      _writeOutput: function (t, e) {
        var s = this.s.d,
          i = "",
          n = this.dom.input;
        s && (i = this._convert(s, null, this.c.format)),
          n.val(i),
          (void 0 !== e && !e) ||
            ((s = new Event("change", { bubbles: !0 })), n[0].dispatchEvent(s)),
          "hidden" === n.attr("type") && this.val(i, !1),
          t && n.focus();
      },
    }),
    (n.use = function (t) {
